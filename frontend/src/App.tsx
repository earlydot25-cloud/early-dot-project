...
import HistoryPage from './pages/dashboard/HistoryPage';
import HistoryDetailPage from './pages/dashboard/HistoryDetailPage'; // ✅ 추가
import ProfilePage from './pages/dashboard/ProfilePage';
import ResultDetailPage from './pages/diagnosis/ResultDetailPage';
      ...
      <Layout>
        <Routes>
          ...
          <Route path="/diagnosis/detail/:id" element={<ResultDetailPage />} />
            ...
            {/* 대시보드 */}
            <Route path="/dashboard" element={<Navigate to="/dashboard/history" replace />} />  {/* ✅ 추가 */}
            <Route path="/dashboard/history" element={<HistoryPage />} />
            <Route
              path="/dashboard/history/:folderName"
              element={<HistoryDetailPage />} // ✅ 상세 보기 경로 추가
            />
            <Route path="/dashboard/profile" element={<ProfilePage />} />
